...
<body class="bg-gray-100 flex justify-center items-center h-screen">
	<div class="relative min-w-screen min-h-screen flex items-center justify-center px-5 py-5">
		<?php
		if (isset($_GET['error'])) {
			$errorMessage = $_GET['error'];
			echo '<div class="card-error absolute top-5 transition-transform ease-in-out duration-500 px-8 py-6 bg-red-400 text-white flex justify-between rounded">
		...
		?>
		<div class="bg-gray-100 text-gray-500 rounded-3xl shadow-[15px_0px_60px_-15px_rgba(0,0,0,0.3)] w-full overflow-hidden" style="max-width:1000px">
			<div class="md:flex w-full">
				<div class="hidden md:block w-1/2 bg-[#557C55] py-10 px-10">
					<svg id="a87032b8-5b37-4b7e-a4d9-4dbfbe394641" data-name="Layer 1"
						...
						<circle id="a4813fcf-056e-4514-bb8b-e6506f49341f" data-name="Ellipse 1" cx="364.43401"
							cy="261.50202" r="24.45" fill="#557C55" />
						...
						<circle id="fcef55fc-4968-45b2-93bb-1a1080c85fc7" data-name="Ellipse 2" cx="225.46401"
							cy="427.41999" r="6.902" fill="#557C55" />
						...
						<circle id="e8fa0310-b872-4adf-aedd-0c6eda09f3b8" data-name="Ellipse 3" cx="225.46401"
							cy="496.43702" r="6.902" fill="#557C55" />
						<path
							...
							transform="translate(-227.576 -76.46149)" fill="#557C55" />
				...
				<form action="includes/auth/authentikasi.php" method="POST" class="w-full md:w-1/2 py-10 px-5 md:px-10">
					...
					<div>
							...
							<div class="w-full px-3 mb-5">
								...
								<div class="flex">
									...
									<input type="text" name="username"
										class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-[#557C55]"
						...
						<div class="flex -mx-3">
							<div class="w-full px-3 mb-5">
								<button name="login"
									class="block w-full max-w-xs mx-auto bg-[#557C55]  text-white rounded-lg px-3 py-3 font-semibold">LOGIN
								</button>
							</div>
						</div>
				</form>
