            ...
            <div class="w-full max-w-[550px] bg-white">
                <form class="py-6 px-9"
                    ...
                    <div class="mb-5">
                        ...
                        <input type="text" value="<?= $row['luas_tanam'] ?>" name="luas_tanam" id="luas_tanam"
                            placeholder="100"
                            class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                    </div>
                    <div class="mb-5">
                        ...
                        <input type="text" value="<?= $row['luas_panen'] ?>" name="luas_panen" id="luas_panen"
                            placeholder="100"
                            class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                    </div>
                    <div class="mb-5">
                        ...
                        <input type="text" value="<?= $row['produktivitas'] ?>" name="produktivitas" id="produktivitas"
                            placeholder="100"
                            class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                    </div>
                    <div class="mb-5">
                        ...
                        <input type="texts" value="<?= $row['produksi_padi'] ?>" name="produksi_padi" id="produksi_padi"
                            placeholder="100"
                            class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md" />
                    </div>
                    <?php
